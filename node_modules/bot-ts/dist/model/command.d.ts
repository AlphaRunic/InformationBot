...
export declare abstract class Command {
     ...
     */
    static find(client: Client, nameOrAlias: string): Command | undefined;
     ...
     */
    hasPermission(msg: Message): Promise<boolean | string>;
    /**
     ...
     */
    abstract run(msg: Message, args?: object): Promise<unknown>;
}
